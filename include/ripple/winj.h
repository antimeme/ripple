 ...
 * ---------------------------------------------------------------------
 *
 * A simplistic Java Virtual Machine.  The name is an initialism that
 * stands for WINJ is not Java.  Also, development has been
 * characterized by complaining (whinging about the design of the Java
 * Virtual Machine and related components.
 *
 * This program has been created for experimental purposes.  Good
 * performance is NOT a goal.  In case that's unclear, this
 * implementation is VERY SLOW because it interprets byte code rather
 * than compiling it, as well as for other reasons.
 *
 * Security is a goal of this implementation, but at present it is
 * far from achieved.  Byte code verification is not implemented.
 * DO NOT ATTEMPT TO EXECUTE UNTRUSTED BYTE CODE.
 *
 * WINJ attempts to implement the invocation interface defined by
 * the Java Native Inteface Specification.
 *
 * https://docs.oracle.com/en/java/javase/25/docs/specs/jni/index.html
 *
 * For the moment, there are lots of ways in which WINJ does not yet
 * comply. Patches welcome! */
#ifndef RIPPLE_WINJ_H
#define RIPPLE_WINJ_H
...
typedef struct winj_object *jobject;
...
typedef struct winj_field  *jfieldID;
typedef struct winj_method *jmethodID;
...
struct JNINativeInterface {
  ...
  jclass (JNICALL *GetSuperclass)(JNIEnv *env, jclass cls);
  jboolean (JNICALL *IsAssignableFrom)
    (JNIEnv *env, jclass cls_from, jclass cls_to);
  ...
  jint (JNICALL *ThrowNew)
    (JNIEnv *env, jclass clazz, const char *message);
  ...
  void (JNICALL *DeleteGlobalRef)(JNIEnv *env, jobject global);
  void (JNICALL *DeleteLocalRef)(JNIEnv *env, jobject local);
  jboolean (JNICALL *IsSameObject)
    (JNIEnv *env, jobject left, jobject right);
  jobject (JNICALL *NewLocalRef)(JNIEnv *env, jobject reference);
  jint (JNICALL *EnsureLocalCapacity)(JNIEnv *env, jint capacity);

  jobject (JNICALL *AllocObject)(JNIEnv *env, jclass cls);
  ...
  void (JNICALL *SetByteField)
    (JNIEnv *env, jobject obj, jfieldID fieldID, jbyte value);
  jchar (JNICALL *GetCharField)
    (JNIEnv *env, jobject obj, jfieldID fieldID);
  void (JNICALL *SetCharField)
    (JNIEnv *env, jobject obj, jfieldID fieldID, jchar value);
  jshort (JNICALL *GetShortField)
    (JNIEnv *env, jobject obj, jfieldID fieldID);
  void (JNICALL *SetShortField)
    (JNIEnv *env, jobject obj, jfieldID fieldID, jshort value);
  ...
  void (JNICALL *SetFloatField)
    (JNIEnv *env, jobject obj, jfieldID fieldID, jfloat value);
  jdouble (JNICALL *GetDoubleField)
    (JNIEnv *env, jobject obj, jfieldID fieldID);
  void (JNICALL *SetDoubleField)
    (JNIEnv *env, jobject obj, jfieldID fieldID, jdouble value);
  ...
  void (JNICALL *GetBooleanArrayRegion)
    (JNIEnv *env, jbooleanArray array,
  ...
  void (JNICALL *ReleaseStringCritical)
    (JNIEnv *env, jstring str, const jchar *carray);
  jobject (JNICALL *NewWeakGlobalRef)(JNIEnv *env, jobject obj);
  void (JNICALL *DeleteWeakGlobalRef)(JNIEnv *env, jobject ref);
...
struct JNIInvokeInterface {
  ...
  jint (JNICALL *AttachCurrentThread)
    (JavaVM *vm, void **p_env, void *thr_args);
  jint (JNICALL *DetachCurrentThread)(JavaVM *vm);
  jint (JNICALL *GetEnv)(JavaVM *vm, void **p_env, jint version);
